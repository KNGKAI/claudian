...
const localizedKeys = [
  ...
  'settings.suggestedPrompts.heading',
  'settings.suggestedPrompts.name',
  'settings.suggestedPrompts.addBtn',
  'settings.suggestedPrompts.noPrompts',
  'settings.suggestedPrompts.labelRequired',
  'settings.suggestedPrompts.promptRequired',
  'settings.suggestedPrompts.deleteConfirm',
  'settings.suggestedPrompts.deleteFailed',
  'settings.suggestedPrompts.added',
  'settings.suggestedPrompts.updated',
  'settings.suggestedPrompts.deleted',
  'settings.suggestedPrompts.modal.titleEdit',
  'settings.suggestedPrompts.modal.titleAdd',
  'settings.suggestedPrompts.modal.label',
  'settings.suggestedPrompts.modal.labelDesc',
  'settings.suggestedPrompts.modal.prompt',
  'settings.suggestedPrompts.modal.promptDesc',
